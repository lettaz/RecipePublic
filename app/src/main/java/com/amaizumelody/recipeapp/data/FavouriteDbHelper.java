package com.amaizumelody.recipeapp.data;
...
public abstract class FavouriteDbHelper{
...
/*
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final  String SQL_CREATE_FAVOURITE_TABLE = "CREATE TABLE " + FavouriteContract.FavoriteEntry.TABLE_NAME +  " (" +
                FavouriteContract.FavoriteEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "+
                FavouriteContract.FavoriteEntry.COLUMN_NAMEOFRECIPE + " TEXT NOT NULL, "+
                FavouriteContract.FavoriteEntry.COLUMN_DESCRIPTION + " TEXT NOT NULL, "+
                FavouriteContract.FavoriteEntry.COLUMN_HEADLINE + " TEXT NOT NULL, "+
                FavouriteContract.FavoriteEntry.COLUMN_IMAGE + " TEXT NOT NULL, "+
                FavouriteContract.FavoriteEntry.COLUMN_INGREDIENT + " TEXT NOT NULL, "+
                "); ";
   ...
   /* public void addFavorite(Movie movie){
        ...
        values.put(FavouriteContract.FavoriteEntry.COLUMN_NAMEOFRECIPE, Recipe.get());
        *//*ContentValues values = new ContentValues();
